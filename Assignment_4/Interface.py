...
'''
DPS ASSIGNMENT 4
CSE 511 - Arizona State University - Fall 2023
Swathi Kotresh Hiremath
1222358371
...
def RangeQuery(ratingsTableName, ratingMinValue, ratingMaxValue, openconnection):
    ...
    with openconnection.cursor() as cursor:
        ...
        for each_table in tables:
            if not (each_table[0] == 'roundrobinratingsmetadata' or each_table[0] == 'rangeratingsmetadata'):
...
def PointQuery(ratingsTableName, ratingValue, openconnection):
    ...
    with openconnection.cursor() as cursor:
        ...
        for eachTable in tables:
            if not (eachTable[0] == 'roundrobinratingsmetadata' or eachTable[0] == 'rangeratingsmetadata'):
